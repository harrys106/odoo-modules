...
//             this.show_warning({type: "Session Expired", data: { message: _t("Your Siroco session expired. Please refresh the current web page.") }});
//             return;
//         }
...
//             size: 'medium',
//             title: "Siroco " + (_.str.capitalize(error.type) || "Warning"),
//             buttons: [
...
//         };
//         new instance.web.Dialog(this, {
//             title: "Siroco " + _.str.capitalize(error.type),
//             buttons: buttons
...
//         window.open('http://help.Siroco.com', '_blank');
//     },
...
//                     scope: 'userinfo',
//                 };
//                 instance.web.redirect('https://accounts.Siroco.com/oauth2/auth?'+$.param(params));
//             }).fail(function(result, ev){
//                 ev.preventDefault();
//                 instance.web.redirect('https://accounts.Siroco.com/web');
//             });
//         }
//     },
